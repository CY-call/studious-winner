...
class DataProcessor:
    ...
    def process_files(self):
        ...
        str_report_path = PathConfig.str_output_dir + '\\' + OutputConfig.str_report_filename
        FileUtils.write_file(str_report_path, str_report)
        
        str_stats_json = ReportGenerator.generate_json_stats(dict_stats)
        str_stats_path = PathConfig.str_output_dir + '\\' + OutputConfig.str_stats_filename
        ...
        if lst_all_invalid_records:
            ...
            str_invalid_path = PathConfig.str_output_dir + '\\' + OutputConfig.str_invalid_filename
